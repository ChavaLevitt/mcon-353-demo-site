  ...
  return (
    ...
    >     
        ...
        <Grid container spacing={2}>
            <Grid item xs={10}>
                <div><Checkbox onClick={() => props.completeTodo(props.index)}
            ...
            <Grid item xs={2}>
                <div>
                    <IconButton onClick={() => props.removeTodo(props.index)} aria-label="delete">
                        <DeleteIcon />
                    </IconButton>
                </div>
            </Grid>
...
export const ToDo = () => {
  ...
  return (
    <div className="app" style={{width:'30%', margin:'auto', padding:'20px'}}>
      <div className="todo-list">
        <div style={{fontSize:'30px', color:'#1d6063', padding:'10px'}}>My ToDo List</div>
      <TodoForm addTodo={addTodo}  />
      <br/>
      <div style={{border: '5px solid #1d6063', borderRadius:'2%', minHeight:'10px'}}>
